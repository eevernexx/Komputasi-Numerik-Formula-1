...
Original file is located at
    https://colab.research.google.com/drive/1tyiRFKor4cou5q9uT4wT2uL-_HlGZiJG
"""
...
def create_feature_inputs():
    ...
    inputs['circuit_difficulty'] = st.sidebar.slider("Circuit Difficulty", 0.0, 1.0, 0.5)
    ...
    inputs['season_progress'] = st.sidebar.slider("Season Progress", 0.0, 1.0, 0.5)
        ...
        if st.button("🚀 Predict Lap Time", type="primary"):
            ...
            with st.spinner("Predicting lap time..."):
                ...
                try:
                    ...
                    - Circuit difficulty: {user_inputs['circuit_difficulty']:.1f}/1.0
                    """)
